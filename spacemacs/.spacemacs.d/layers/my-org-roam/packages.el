;;; packages.el --- my-org-roam layer packages file for Spacemacs.  -*- lexical-binding: t -*-
;;
...
(defun my-org-roam/post-init-biblio ()
  ...
  (spacemacs/set-leader-keys "obD" #'my/biblio-doi-to-zotero))
